...
var menu = new ConsoleMenu(projectService, engine, reportGenerator);
...
//File.WriteAllText(
//    @"wwwroot\metadata.json",
//    metadataString
//);

//BuildAndRunHttpServer(args);
...
//static void BuildAndRunHttpServer(string[] args)
//{
...
//    {
//        return Results.File(
//            @"C:\dev\myGitHub\calc\Projects\Current\input.json",
//            "application/json");
//    });

//    app.MapPost("/project", async (CalculationInput input) =>
//    {
//        File.WriteAllText(
//            @"C:\dev\myGitHub\calc\Projects\Current\input.json",
...
//        //    ReportGenerator.Generate(input, result));
...
//    {
//        var input = JsonSerializer.Deserialize<CalculationInput>(File.ReadAllText(
//            @"C:\dev\myGitHub\calc\Projects\Current\input.json"));
...
//    var url = "http://localhost:8080/input.html";
...
//        var slopeGeometry = new SlopeGeometry(input.Geometry.First());
